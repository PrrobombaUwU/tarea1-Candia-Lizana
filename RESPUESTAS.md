...
El archivo README.md es importante porque funciona como portada de nuestro proyecto, ayudando asi para aquel que no estuvo dentro del proyecto, pueda entender la funcion de este, objetivos y el como utilizarlo.


##2


El MAKEFILE tiene la utilidad de ser una herramienta que facilita las tareas de compilacion, definiendo comandos, gestionando archivos, entre otras cosas. ademas puede operar en lenguajes que no sean c/c++ como java, python y entre varios más. eso si, hay que tener ciertas consideraciones especiales como que debe ser portable entre diferentes sistemas, considerar diferencias en paths y comandos entre sistemas.
